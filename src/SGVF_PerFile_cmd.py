...
def _addargs(parser):
    parser.add_argument('deltaf', help = 'The delta file to process', required = True)
    parser.add_argument('outf', help = 'Path to processed file', required = True)
    parser.add_argument('average_read_length', help = 'Average read length in the original sample', required = True)
